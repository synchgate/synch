      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
          ...
          <h4 className="text-lg font-bold text-slate-900 mb-2">
            Provider Monitoring is coming soon
          </h4>
          <p className="text-sm text-slate-500 max-w-sm leading-relaxed">
            We're building a comprehensive health dashboard for all your payment providers. 
            Soon you'll be able to monitor latency, success rates, and service degradation in real-time.
          </p>

          <div className="mt-8 grid grid-cols-3 gap-4 w-full max-w-sm">
            {[
              { icon: Activity, label: "Success Rates" },
              { icon: ShieldCheck, label: "Health Checks" },
              { icon: Building2, label: "Multi-Provider" },
            ].map((item, i) => (
              <div
                key={i}
